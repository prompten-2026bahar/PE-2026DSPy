...
*Kaynak kod: `.venv/lib/python3.14/site-packages/dspy/adapters/xml_adapter.py`*
...
`XMLAdapter`, girdi ve çıktı alanlarının `<field_name>` gibi XML etiketleri (XML tags) içine sarılmasını (wrapped) gerektirir.
