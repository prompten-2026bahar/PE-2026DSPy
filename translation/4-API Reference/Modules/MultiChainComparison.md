# /translation/multi_chain_comparison.md
...
| :--- | :--- | :--- | :--- |
| `signature` | - | Modülün imzası. | **Gerekli (required)** |
| `M` | `int` | Karşılaştırılacak zincir (chain) sayısı. | `3` |
| `temperature` | `float` | Çıktı üretimi için kullanılacak sıcaklık (temperature) değeri. | `0.7` |
| `**config` | - | Modül için ek yapılandırma (configuration) ayarları. | `{}` |

*Kaynak kod: `.venv/lib/python3.14/site-packages/dspy/predict/multi_chain_comparison.py`*
